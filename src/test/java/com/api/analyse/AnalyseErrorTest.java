...
public class AnalyseErrorTest {
    ...
    public void init() {
        ...
        logs.add(new Log("AnalyseErrorTest", 1, l1, null));
        logs.add(new Log("AnalyseErrorTest", 2, l2, null));
        logs.add(new Log("AnalyseErrorTest", 3, l3, null));
        logs.add(new Log("AnalyseErrorTest", 4, l4, null));
        logs.add(new Log("AnalyseErrorTest", 5, l5, null));
    }
